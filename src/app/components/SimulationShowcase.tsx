...
const simulations = [
  {
    ...
    link: 'https://ro.blox.com/Ebh5?af_dp=roblox%3A%2F%2Fnavigation%2Fgame_details%3FgameId%3D8656910792&af_web_dp=https%3A%2F%2Fwww.roblox.com%2Fgames%2F127554112947841',
  },
  {
    id: 2,
    ...
    link: 'https://www.roblox.com/share?code=81784dd478770440b196549e266886b3&type=ExperienceDetails&stamp=1757779868695',
  },
];
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${player.rank === 1 ? 'bg-gradient-to-br from-yellow-400 to-orange-500 text-white' :
